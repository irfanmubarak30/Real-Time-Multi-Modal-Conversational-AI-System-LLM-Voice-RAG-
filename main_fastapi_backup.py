...
class WhatsAppBot:
    ...
    def __init__(self):
        ...
        self.placement_keywords = [
            ...
            'recruitment', 'recruiter', 'hr', 'human resources', 'interview',
            'job opportunity', 'job opening', 'vacancy', 'position', 'role',
            'work', 'employment rate', 'job statistics', 'placement record',
            'campus placement', 'job fair', 'placement drive', 'recruitment drive',
            'job market', 'industry', 'corporate', 'mnc', 'startup', 'tech job',
            'software job', 'developer job', 'coding job', 'programming job',
            'placement cell', 'placement officer', 'job portal', 'linkedin',
            'resume', 'cv', 'job application', 'job search', 'career guidance',
            
            # Malayalam keywords
            'പ്ലേസ്മെന്റ്', 'പ്ലേസ്‌മെന്റ്', 'പ്ലേസ്മെന്റിനെ', 'പ്ലേസ്മെന്റിനെക്കുറിച്ച്', 'പ്ലേസ്മെന്റിന്റെ',
            'പ്ലേസ്മെന്റിൽ', 'പ്ലേസ്മെന്റുകൾ', 'പ്ലേസ്മെന്റ് ആയി', 'പ്ലേസ്മെന്റ് എന്ന്', 'പ്ലേസ്മെന്റ് ആണ്',
            'പ്ലേസ്മെന്റ് ഉണ്ട്', 'പ്ലേസ്മെന്റ് ഉണ്ടോ', 'പ്ലേസ്മെന്റ് കിട്ടും', 'പ്ലേസ്മെന്റ് കിട്ടുമോ',
            'പ്ലേസ്മെന്റ് ലഭിക്കും', 'പ്ലേസ്മെന്റ് ലഭിക്കുമോ', 'പ്ലേസ്മെന്റ് സഹായം', 'പ്ലേസ്മെന്റ് പറ്റി',
            'ജോലി', 'കരിയർ', 'ശമ്പളം', 
            'ജോലിയെക്കുറിച്ച്', 'ജോലി കിട്ടുമോ', 'ജോലി ഉറപ്പാണോ', 'ജോലി ഗ്യാരണ്ടി',
            'പ്ലേസ്മെന്റ് ഗ്യാരണ്ടി', 'പ്ലേസ്മെന്റിനെ', 'കമ്പനിയിൽ ജോലി', 'ജോലി സഹായം', 'കരിയർ സപ്പോർട്ട്',
            'പ്ലേസ്മെന്റിനെക്കുറിച്ച്', 'ജോലിയുടെ', 'ജോലി ലഭിക്കുമോ', 'ജോലി കിട്ടും', 'എത്ര ശമ്പളം',
            'പാക്കേജ്', 'സാലറി', 'കമ്പനികൾ', 'ജോലി അവസരങ്ങൾ', 'ജോലി സാധ്യത',
            'പ്ലേസ്മെന്റ് റേറ്റ്', 'ജോലി ശതമാനം', 'എത്ര പേർക്ക് ജോലി', 'ജോലി സ്ഥിതിവിവരക്കണക്ക്',
            'ജോലി വിവരങ്ങൾ', 'പ്ലേസ്മെന്റ് വിവരങ്ങൾ', 'ജോലി റിപ്പോർട്ട്', 'പ്ലേസ്മെന്റ് റിപ്പോർട്ട്',
            'റിക്രൂട്ട്മെന്റ്',
             'ജോലി നിരക്ക്', 'കാമ്പസ് പ്ലേസ്മെന്റ്', 'പ്ലേസ്മെന്റ് ഡ്രൈവ്',
            'ജോബ് മാർക്കറ്റ്', 'ഇൻഡസ്ട്രി', 'കോർപ്പറേറ്റ്', 'എംഎൻസി', 'സ്റ്റാർട്ടപ്പ്', 'ടെക് ജോബ്',
            'സോഫ്റ്റ്‌വെയർ ജോബ്', 'ഡെവലപ്പർ ജോബ്', 'കോഡിംഗ് ജോബ്', 'പ്രോഗ്രാമിംഗ് ജോബ്',
            'പ്ലേസ്മെന്റ് സെൽ', 'പ്ലേസ്മെന്റ് ഓഫീസർ', 'ജോബ് പോർട്ടൽ',
            'റെസ്യൂമെ', 'സിവി', 'ജോബ് ആപ്ലിക്കേഷൻ', 'ജോബ് സെർച്ച്', 'കരിയർ ഗൈഡൻസ്',
            'ജോലി തേടുന്നു', 'ജോലി വേണം', 'ജോലി കിട്ടണം', 'ജോലി ചെയ്യണം', 'ജോലി ലഭിക്കണം'
        ]
    ...
    def detect_fees_intent(self, message):
        ...
        # Exclude competitor/comparison questions
        competitor_patterns = [
            r'other.*academ',
            r'other.*institut',
            r'other.*center',
        ...
        for pattern in competitor_patterns:
            if re.search(pattern, message_lower):
                return False  # Don't trigger fees for competitor questions
        
        # Check for direct fees keywords (more specific)
        direct_fees_keywords = [
            'fees', 'fee', 'cost', 'price', 'pricing', 'payment', 'money',
            'fee structure', 'course fee', 'tuition', 'charges', 'expense',
            'installment', 'emi', 'scholarship', 'discount',
            'ഫീസ്', 'വില', 'പണം', 'ചെലവ്', 'തുക', 'പേയ്മെന്റ്', 'എത്ര', 'ബജറ്റ്'
        ]
        
        for keyword in direct_fees_keywords:
            if keyword in message_lower:
                return True
    ...
    async def send_placement_images(self, to_phone):
        """Send placement image and PDF document to the user (async)"""
        try:
            success_count = 0
            ...
            try:
                await self.send_media_message(to_phone, self.placement_image['url'], caption=self.placement_image['caption'])
                success_count += 1
            ...
            try:
                await self.send_document_message(to_phone, self.placement_pdf['url'], caption=self.placement_pdf['caption'], filename="LevelX_Placement_Details.pdf")
                success_count += 1
    ...
    async def send_fees_images(self, to_phone):
        ...
        try:
            ...
            for i, image_data in enumerate(self.fees_images, 1):
                try:
                    await self.send_media_message(to_phone, image_data['url'], caption=image_data['caption'])
                    success_count += 1
...
"""
    ...
    async def send_flutter_reel(self, to_phone):
        """Send Flutter reel to the user (async)"""
        try:
            # Send the reel link with caption
            ok = await self.send_whatsapp_message(to_phone, f"{self.flutter_reel['caption']}\n\n{self.flutter_reel['url']}")
            ...
            try:
                ...
                if survey_completed:
                    ...
                    if (inactive_minutes >= self.follow_up_minutes and 
                        ...
                        await self.send_whatsapp_message(phone, message)
    ...
    try:
        ...
        if msg.type == 'text' and msg.text:
            ...
            if interactive.type == 'button_reply' and interactive.button_reply:
                button_id = interactive.button_reply.id or ''
        ...
        if message_body:
            ...
            if not user_session['language_selected']:
                ...
                if message_body.lower() in ['reset', 'restart', 'start over', 'പുനരാരംഭിക്കുക']:
                    ...
                    # Handle Q1 "Other" specification
                    user_session['awaiting_q1_other'] = False
                    user_session['chatbot'].current_lead.survey_answers['q1'] = f"Other: {message_body}"
                    
                    # Send follow-up and proceed to Q2
                    language = user_session.get('preferred_language', 'english')
                    followup = "വളരെ നല്ലത്! Tech career ആരംഭിക്കാൻ താങ്കൾ ശരിയായ സ്ഥലത്തിലാണ് എത്തിയിരിക്കുന്നത്!" if language == 'malayalam' else "Awesome, you're at the right place to jumpstart your tech career!"
                    
                    await whatsapp_bot.send_whatsapp_message(from_number, followup)
                    user_session['chatbot'].lead_status = LeadStatus.SURVEY_Q2
                    user_session['current_survey_question'] = 'q2'
                    await whatsapp_bot.send_survey_poll(from_number, 'q2')
                    response_text = None
                ...
                # Intent detection
                elif whatsapp_bot.detect_placement_intent(message_body) and not user_session.get('placement_images_sent', False):
                    ...
                    # Always process the message through chatbot for Flutter queries
                    response_text = user_chatbot.ask(message_body)
                else:
