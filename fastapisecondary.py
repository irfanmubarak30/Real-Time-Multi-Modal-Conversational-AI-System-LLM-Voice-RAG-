...
"""
    ...
    async def send_exclusive_offer_buttons(self, to_phone, language='english'):
        ...
        try:
            if language == 'malayalam':
                body_text = "നിങ്ങൾക്ക് LevelX AI-ന്റെ വ്യക്തിഗത പതിപ്പ് വേണമോ? നിങ്ങളുടെ പ്രത്യേക ലക്ഷ്യങ്ങളും പശ്ചാത്തലവും അടിസ്ഥാനമാക്കി 4 ചോദ്യങ്ങളുള്ള ഒരു ക്വിക്ക് സർവേ വഴി ഒരു ഇഷ്ടാനുസൃത പഠന പാത സൃഷ്ടിക്കാം."
                yes_text = "അതെ"
                no_text = "ഇല്ല"
            else:
                body_text = "Would you like a personalized version of LevelX AI? I can create a customized learning path based on your specific goals and background through a quick 4-question survey."
                yes_text = "Yes"
                no_text = "No"
